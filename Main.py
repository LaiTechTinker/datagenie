...
Datasets={} #in memory dataset store, can be enhanced to persistent if needed
...
def chat_report():
    try:
        ...
        return jsonify({"error": str(e)}), 500
# this code block will generate preview of the dataset based on the file_id, it will return the first 5 rows of the dataset in json format for preview in the frontend
