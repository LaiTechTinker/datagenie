...
If helpful but necessary, include a table like:
...
If helpful but necessary, summarize key relationships in a table:
...
If useful but necessary, include a structured table:
